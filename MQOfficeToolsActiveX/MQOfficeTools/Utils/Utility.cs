...
namespace Wrapper.Common.Utils
{
    ...
    { 
        ...
        public static string Object2XMLString(object obj)
        {
            ...
            responseXML = Utility.ConvertEncode(responseXML, CodePage.SYS_DEFAULT, CodePage.ISO_8859_1);
           ...
           Encoding encode = System.Text.Encoding.UTF8;
            ...
            switch (codepage)
            {
                ...
                case 28591: // ISO-8859-1 ( for PB7 )
                    responseXML = Utility.ConvertEncode(responseXML, CodePage.SYS_DEFAULT, encoding);
                    break;
                default:
                    break;
            }
