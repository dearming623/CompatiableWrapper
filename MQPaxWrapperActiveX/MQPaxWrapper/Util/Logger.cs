...
/// </summary>
/// 
[Obsolete("This method will be removed in v1.19.")]
public sealed class Logger
{
    ...
    private const string log_root_directory = @"";
    ...
    private static string GetLogFullPath
    {
        get
        {
            ...
            return string.Concat(Directory.GetCurrentDirectory() + log_root_directory, '\\', "sig", ".log");
